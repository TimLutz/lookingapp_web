var TableAjax = function () {
   ...
   var customFunction = function () {
			$("#datatable_ajax_for_skill input").not('input[type="checkbox"]').on('keyup',function (e) {
					$('.filter-submit').click();  
			});
			$("#datatable_ajax_for_skill select").not('input[type="checkbox"]').on('keyup change',function (e) {
					$('.filter-submit').click();  
			});
   }
   var refreshRecords = function () {
	   var $myTable = $("#datatable_ajax_for_skill").dataTable( { bRetrieve : true } );
		$myTable.fnDraw();
   }
