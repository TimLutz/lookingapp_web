var TableAjax = function () {
   ...
   var customFunction = function () {
			$("#datatable_ajax_for_faq input").not('input[type="checkbox"]').on('keyup',function (e) {
					$('.filter-submit').click();  
			});
			$("#datatable_ajax_for_faq select").not('input[type="checkbox"]').on('keyup change',function (e) {
					$('.filter-submit').click();  
			});
   }
   var refreshRecords = function () {
	   var $myTable = $("#datatable_ajax_for_faq").dataTable( { bRetrieve : true } );
		$myTable.fnDraw();
   }
