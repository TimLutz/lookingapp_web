...
<?php echo $this->Form->create('RecentImage', array('type' => 'file')); ?>
...
<div class="well">
    ...
    ?><br/><br/>
        <label>Image* </label>
        <?php echo $this->Form->input('image', array('label' => FALSE, 'div' => FALSE, 'type' => 'file', 'class' => 'input-xlarge', 'id' => 'image','required'=>true)); ?>
    </div>
