<div class="header">
    <h1 class="page-title">Notes List</h1>
</div>
...
<div class="search-well">
    ...
    echo $this->Form->create('User',array('type' => 'post','url' => array('controller' => 'users','action' => 'note','admin' => TRUE)));
...
<div class="btn-toolbar">
    <a href="<?php echo $this->Html->url(array('action' => 'add_note', 'admin' => TRUE, 'user')); ?>" class="btn btn-primary"><i class="icon-plus"></i> Add</a>
</div>
<!-- New user button start -->
            ...
            if ($count) {
                ...
                foreach ($results as $loop => $result) {
                    ...
                    <tr>
                       ...
                       <td><?php echo $result['Note']['note']; ?></td>
                        
                       <td>
                            
                           <a href="<?php echo $this->Html->url(array('action' => 'edit_note', 'admin' => TRUE, $result['Note']['id'])); ?>" title="Edit"><i class="icon-pencil"></i></a>
                            <a href="<?php echo $this->Html->url(array('action' => 'delete_note', 'admin' => TRUE, $result['Note']['id'])); ?>" onclick="if (!confirm('Are you sure want to delete this record permanently?')) return false;" title="Delete"><i class="icon-remove"></i></a>
                        </td>
                    </tr>
                    <?php
                }
