<div class="header">
    <h1 class="page-title">Viewed List</h1>
</div>
...
<div class="search-well">
    ...
    echo $this->Form->create('User', array('type' => 'post', 'url' => array('controller' => 'users', 'action' => 'viewed', 'admin' => TRUE)));
...
<!--                <th>Email</th>
        ...
        <!--                        <td><?php echo date('d-M-Y', strtotime($result['User']['dob'])); ?></td>-->
                        ...
                        <td>
                            ...
                            <a href="<?php echo $this->Html->url(array('action' => 'delete_viewer_viewed', 'admin' => TRUE, $result['Viewer']['id'],'viewed')); ?>" onclick="if (!confirm('Are you sure want to delete this record permanently?'))
