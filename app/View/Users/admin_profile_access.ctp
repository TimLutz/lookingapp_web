<div class="header">
    <h1 class="page-title">Profile Access List</h1>
</div>
...
<div class="search-well">
    ...
    echo $this->Form->create('User', array('type' => 'post', 'url' => array('controller' => 'users', 'action' => 'profile_access', 'admin' => TRUE)));
...
<!--                <th>Email</th>
        ...
        <!--                        <td><?php echo date('d-M-Y', strtotime($result['User']['dob'])); ?></td>-->
                        ...
                        <td>
                            ...
                            <?php
                            if ($result['ProfileLock']['is_locked'] == 2) {
                            ...
                            <a href="<?php echo $this->Html->url(array('action' => 'change_profile_status', 'admin' => TRUE, $result['ProfileLock']['id'], $statusval)); ?>" title="Change Status to <?php echo $status; ?>"><i class="<?php echo $class; ?>"></i></a>
                            <a href="<?php echo $this->Html->url(array('action' => 'delete_profile_access', 'admin' => TRUE, $result['ProfileLock']['id'])); ?>" onclick="if (!confirm('Are you sure want to delete this record permanently?'))
