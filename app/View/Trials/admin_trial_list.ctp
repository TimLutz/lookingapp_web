<div class="header">
    <h1 class="page-title">Trial Management</h1>
</div>
                ...
                foreach ($results as $loop => $result) {
                    ...
                    <tr>
                       ...
                       <!-- <td><?php echo $result['UserRestriction']['limit_type']; ?></td>-->
                        <td><?php echo $result['Trial']['month']; ?>  Day(s)</td>
                        <!--<td><?php echo date('d-M-Y',strtotime($result['Trial']['creation_date'])); ?></td>-->
                        
                        <td>
                            <a href="<?php echo $this->Html->url(array('action' => 'edit_trial', 'admin' => TRUE, $result['Trial']['id'])); ?>" title="Edit"><i class="icon-pencil"></i></a>
