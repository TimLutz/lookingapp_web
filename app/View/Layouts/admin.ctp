...
<html>
  ...
  <meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
	...
	echo $this->Html->css('admin/bootstrap-select');
	echo $this->Html->css('admin/custom');
    echo $this->Html->css('admin/lightbox');
	...
	echo $this->Html->script('bootstrap/js/bootstrap-select');
    ...
    <body class=""> 
        ...
        <div class="content" <?php if (!$this->Session->check('Auth.Admin')) { ?>style="margin-left: 0;"<?php } ?>>
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <!-- Footer start -->
                    <?php /*?><?php echo $this->element('admin/footer'); ?><?php */?>
                    <!-- Footer end -->
        ...
        <?php
         ...
         echo $this->Html->script('lightbox-plus-jquery.min');
        ?>
