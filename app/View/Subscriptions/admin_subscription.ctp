            ...
            if ($count) {
                ...
                foreach ($results as $loop => $result) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $result['Subscription']['month']; ?><?php if($result['Subscription']['month']>0){ echo ' months';}else{echo ' month';}?></td>
                        <td><?php echo '$'.$result['Subscription']['price']; ?></td>
                        <td><?php echo date('d-M-Y',strtotime($result['Subscription']['creation_date'])); ?></td>
                        
                        <td>
                            <a href="<?php echo $this->Html->url(array('action' => 'edit_subscription', 'admin' => TRUE, $result['Subscription']['id'])); ?>" title="Edit"><i class="icon-pencil"></i></a>
