...
function initInVieport() {
	jQuery('[data-animation]').itemInViewport({
...
function initCarousel() {
	...
	jQuery('.staff-carousel').scrollGallery({
		mask: '.mask',
		slider: '.slideset',
		slides: '.slide',
		btnPrev: 'a.btn-prev',
	...
	jQuery('.carousel-items').scrollGallery({
		mask: '.mask',
		slider: '.post-area',
		slides: '.post',
		btnPrev: 'a.btn-prev',
...
function initSameHeight() {
	jQuery('.list-selector').sameHeight({
		elements: '.text-holder',
		flexible: true,
		multiLine: true,
		biggestHeight: true
	});
	jQuery('.block-product').sameHeight({
		elements: '.text-holder',
		flexible: true,
		multiLine: true,
		biggestHeight: true
