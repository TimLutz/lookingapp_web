          ...
          <div>
            <center>
              <table cellspacing="0" cellpadding="0" width="530" height="303" class="w320">
                <tr>
                  <td style="color: #21c5ba" valign="middle" style="vertical-align:middle; padding-right: 15px; padding-left: 15px; text-align:left;" class="mobile-center" height="303">

                    <h1>Reset Password!</h1>
                    <h2>You have requested for change Password</h2>
                    ...
                    <tr>
                      <td style="width:200px; background-color: #3bcdc3;">
                        <div><!--[if mso]>
                          ...
                          <![endif]-->
                          <!--[if !mso]><!-- --><a href="{{url('password/reset',$token)}}"><table cellspacing="0" cellpadding="0" width="100%"><tr><td style="background-color:#3bcdc3;border-radius:0px;color:#ffffff;display:inline-block;font-family:'Lato', Helvetica, Arial, sans-serif;font-weight:bold;font-size:13px;line-height:33px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;mso-hide:all;"><span style="color:#ffffff">Reset Password</span></td></tr></table></a>
                          <!--<![endif]-->
                        </div>
                      </td>
                      <td>
