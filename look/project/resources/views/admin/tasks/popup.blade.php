<div class="modal fade" id="myModal" role="dialog">
                                ...
                                <div class="modal-dialog">
									...
									<div class="form-group">
										{!! Form::label('status', 'Status: ',['class' => 'control-label','id' => 'statusdata']) !!} <span class="star"></span>
											...
											{!! Form::select('status', array('2' => 'Declined','3' => 'Accepted'),null,['class' => 'form-control','id' => 'status']) !!}
								...
								{!! Form::hidden('tasktime',null,['class' => 'form-control','id' => 'taskperforming']) !!}
                                        ...
                                        <div class="modal-footer">
											{!! Form::button('submit',['id'=>'updatestatus','class' => 'btn btn-primary statuschangebutton']) !!} 
                                            {!! Form::close() !!}
