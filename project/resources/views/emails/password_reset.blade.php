                        ...
                        <table bgcolor="#e8eaed" width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                           <tbody>
                              <tr>
                                 <!-- start of image -->
                                 <td align="center">
                                    <a target="_blank" href="#"><img width="600" border="0" height="150" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="http://limeblast.co.uk/wp-content/uploads/2013/07/laravel___ignited_by_rafdesign-d53afsw-632x316-1373977453.jpg" class="logo"></a>
                                 </td>
                              </tr>
                           </tbody>
                        </table>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #ffffff">
                                    Too many newsletters? You can <a href="#" style="text-decoration: none; color: #9ec459">unsubscribe </a> 
                                 </td>
                              </tr>
                              <!-- Spacing -->
                              <tr>
