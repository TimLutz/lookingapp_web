...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="{{ url(getenv('adminurl').'/users/index-technician') }}">Manage Technicians</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
<!--
					...
					<div class="portlet">
						<div class="portlet-body">
							<div class="table-container">
								...
								<input type="hidden" name="action" value="users/list-technician"/>
...
-->
										<a href="{{url('/'.getenv('adminurl').'/users/create-user/Technician')}}" class="btn blue btn-sm pull-right">Create Technician</a>
								</div>
...
-->
									...
									<th width="10%">
										 Status &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
									</th>
...
-->
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="domain" id="domain" autocomplete="off">
									</td>
									<td>
			...
			@include('admin.technicians.popup')
@endsection
@section('js')
<script>
                   ...
                   if(result.reslutset.name)
                    ...
                    if(result.reslutset.email)
                     ...
                     $('#address_user').text('NA');
                      ...
                      if(result.reslutset.domain)
                     $('#domain_user').text(result.reslutset.domain);
                     else
                     $('#domain_user').text('NA');
