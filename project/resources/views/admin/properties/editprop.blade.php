...
<div class="tab-pane" id="tab_1">
				<?php 
				 $prop_attrs = $property->property_attributes()->get(); 
				 $result= count($prop_attrs); ?>
				 
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Edit Property
										</div>
<!--
										<div class="tools">
...
<div class="portlet-body form">
    ...
    {!! Form::model($property,['method' => 'POST','url' => '/'.getenv('adminurl').'/properties/update/'.Crypt::encrypt($property->id),'files' => 'true','id'=>'editprops']) !!}
   
    @include('admin.properties.formedit',['submitButtonText' => 'Update Property'])
    {!! Form::hidden('action','edit') !!}
    <?php $idedit = Crypt::encrypt($property->id); ?>
...
jQuery(document).ready(function() {     
	$('#adduserbutton').click(function(){
	 var formData = new FormData($('#editprops')[0]);
		var id = "<?php echo $idedit; ?>";
	$.ajax({
		dataType: 'json',
		method:'post',
		processData: false,
		contentType: false,
		url: path+'nimdaalf/properties/update/'+id,
		data: formData,
		beforeSend : function() {
			addLoader();
		},
...
var x = "<?php echo $result; ?>"; //initlal text box count
var y ="<?php echo $result; ?>";
    $(".add_field_button2").click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
			...
			showErrorMessage('You have reached your limit of 10');
		}
    });
