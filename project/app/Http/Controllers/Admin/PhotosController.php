...
class PhotosController extends Controller
{
    ...
    public function postListAllPhotos(Request $request)
    {
        ...
        foreach($resultset as $value){
            ...
            $status='<div class="statuscenter"><a  id="change-photo-status" data-table="users" data-id="'.\Crypt::encrypt($value->id).'" data-photostatus="'.$value->photo_change.'" data-action="Plans" class="current_users" title="Change Status to Approve"><i class="fa fa-check-circle text-success active"></i><a><a  id="change-common-status" data-table="users" data-id="'.$value->id.'" data-status="'.$value->status.'" data-action="Plans" title="Change Status to Ban"><i class="fa fa-ban text-danger active"></i><a></div>';
