...
|
*/
Route::get('testing', 'PasswordController@test');
...
Route::get('/apifrontline-dev/reset-password/{id}', 'PasswordController@reset');
Route::post('apifronline-dev/reset', 'PasswordController@resetpassword'); 
