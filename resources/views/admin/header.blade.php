...
<link href="{{ asset( 'public/admin/css/fullcalendar.min.css' ) }}" rel="stylesheet" type="text/css"/>
...
<link rel="stylesheet" type="text/css" href="{{ asset( 'public/admin/css/select2.css') }}"/>

<link rel="stylesheet" type="text/css" href="{{ asset( 'public/admin/css/multi-select.css' ) }}"/>
<link rel="stylesheet" type="text/css" href="{{ asset( 'public/admin/css/dataTables.colReorder.min.css' ) }}"/>
<link rel="stylesheet" type="text/css" href="{{ asset( 'public/admin/css/dataTables.bootstrap.css') }}"/>
<!-- END PAGE STYLES -->
@yield('css2')
<!-- BEGIN THEME STYLES -->
