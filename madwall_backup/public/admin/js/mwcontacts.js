var TableAjax = function () {
    ...
    var handleRecords = function () {
        ...
        grid.init({
            src: $("#datatable_ajax_for_contacts"),
   ...
   var customFunction = function () {
			$("#datatable_ajax_for_contacts input").not('input[type="checkbox"]').on('keyup',function (e) {
					$('.filter-submit').click();  
			});
			$("#datatable_ajax_for_contacts select").not('input[type="checkbox"]').on('keyup change',function (e) {
					$('.filter-submit').click();  
			});
   }
   var refreshRecords = function () {
	   var $myTable = $("#datatable_ajax_for_contacts").dataTable( { bRetrieve : true } );
		$myTable.fnDraw();
   }
