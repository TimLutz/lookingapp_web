var TableAjax = function () {
   ...
   var customFunction = function () {
			$("#datatable_ajax_for_jobs input").not('input[type="checkbox"]').on('keyup',function (e) {
					$('.filter-submit').click();  
			});
			$("#datatable_ajax_for_jobs select").not('input[type="checkbox"]').on('keyup change',function (e) {
					$('.filter-submit').click();  
			});
   }
   var refreshRecords = function () {
	   var $myTable = $("#datatable_ajax_for_jobs").dataTable( { bRetrieve : true } );
		$myTable.fnDraw();
   }
