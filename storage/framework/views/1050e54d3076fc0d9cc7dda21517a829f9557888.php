...
<?php echo Form::open(['url'=>'employer/savejob','id'=>'addjob']); ?>
...
<?php echo Form::select('job_subcategory',[''=>'Please select Sub-Category'],null,['class'=>'customselect ','id'=>'subcategory','data-jcf'=>'{"wrapNative": false, "wrapNativeOnMobile": false, "fakeDropInBody": false, "useCustomScroll": false}']); ?>
...
<div class="field_forms"><div class="label_form"><label>Job Skills</label></div><div class="form_inputs skills">
	<?php echo Form::select('skills[]',[],null,['class'=>'chosen-select skills','multiple'=>'multiple','id'=>'multiselect','data-placeholder'=>'Select some Skills']); ?>
...
<div class="row">
<div class="col-md-6"><div class="field_forms"><div class="label_form"><label>Start Time</label></div><div class="form_inputs"><?php echo Form::text('start_date',null,['id'=>'start_date','onkeydown'=>'return false']); ?>

	<span class="error_msgg" style="display:none;"></span>
</div></div></div>
<div class="col-md-6"><div class="field_forms"><div class="label_form"><label>End Time</label></div><div class="form_inputs"><?php echo Form::text('end_date',null,['id'=>'end_date','onkeydown'=>'return false']); ?>
